...
if __name__ == '__main__':
    ...
    TRAIN_TF_IDF_FILE = '../datasets/20news-bydate/20news-train-tf_idf.txt'
    TEST_TF_IDF_FILE = '../datasets/20news-bydate/20news-test-tf_idf.txt'
    NUM_CLASSES = 20
    ...
    test_data_reader = DataReader(
        data_path = '../datasets/20news-bydate/20news-test-tf_idf.txt',
        batch_size = 50,
        vocab_size = vocab_size
    )
